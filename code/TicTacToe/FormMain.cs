...
namespace TicTacToe
{
  public partial class FormMain : Form
  {
    ...
    {
      SetFieldStatus(0, 0, (Button)sender);
    }

    private void btn01_Click(object sender, EventArgs e)
    {
      SetFieldStatus(0, 1, (Button)sender);
    }

    private void btn02_Click(object sender, EventArgs e)
    {
      SetFieldStatus(0, 2, (Button)sender);
    }

    private void btn10_Click(object sender, EventArgs e)
    {
      SetFieldStatus(1, 0, (Button)sender);
    }

    private void btn11_Click(object sender, EventArgs e)
    {
      SetFieldStatus(1, 1, (Button)sender);
    }

    private void btn12_Click(object sender, EventArgs e)
    {
      SetFieldStatus(1, 2, (Button)sender);
    }

    private void btn20_Click(object sender, EventArgs e)
    {
      SetFieldStatus(2, 0, (Button)sender);
    }

    private void btn21_Click(object sender, EventArgs e)
    {
      SetFieldStatus(2, 1, (Button)sender);
    }

    private void btn22_Click(object sender, EventArgs e)
    {
      SetFieldStatus(2, 2, (Button)sender);
    }
